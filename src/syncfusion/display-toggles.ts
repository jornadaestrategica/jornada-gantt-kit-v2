...
export type DisplayToggleId =
  | "showAnnotations" | "showBaseline" | "showCriticalPath" | "highlightChanges" | "toolbarLabels" | "showTodayMarker" | "showDependencyLines"
...
export const DISPLAY_TOGGLES: DisplayToggle[] = [
  ...
  { id: "showTodayMarker", label: "Mostrar indicador de hoje", short: "Hoje" },
  { id: "showDependencyLines", label: "Mostrar conexões entre atividades", short: "Conexões" },
]

const DEFAULT_ON = new Set<DisplayToggleId>(["showAnnotations", "highlightChanges", "toolbarLabels", "showDependencyLines"])
